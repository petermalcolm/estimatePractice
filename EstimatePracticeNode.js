EstimatePracticeNode.prototype = new Node();
EstimatePracticeNode.prototype.constructor = EstimatePracticeNode;
EstimatePracticeNode.prototype.parent = Node.prototype;

/*
 * the name that displays in the authoring tool when the author creates a new step
 */
EstimatePracticeNode.authoringToolName = "EstimatePractice"; 

/*
 * will be seen by the author when they add a new step to their project to help
 * them understand what kind of step this is
 */
EstimatePracticeNode.authoringToolDescription = "This is a generic step only used by developers";
 ...
 * @param view
 */
function EstimatePracticeNode(nodeType, view) {
	this.view = view;
	this.type = nodeType;
 ...
 */
EstimatePracticeNode.prototype.parseDataJSONObj = function(stateJSONObj) {
	return EstimatePracticeState.prototype.parseDataJSONObj(stateJSONObj);
};
 ...
 */
EstimatePracticeNode.prototype.translateStudentWork = function(studentWork) {
	return studentWork;
};
 ...
 */
EstimatePracticeNode.prototype.onExit = function() {
 ...
 */
EstimatePracticeNode.prototype.renderGradingView = function(divId, nodeVisit, childDivIdPrefix, workgroupId) {
	//Get the latest student state object for this step
	var estimatePracticeState = nodeVisit.getLatestWork();
	...
	var studentWork = estimatePracticeState.getStudentWork();
 ...
 */
EstimatePracticeNode.prototype.getHTMLContentTemplate = function() {
	return createContent('node/estimatePractice/estimatePractice.html');
};

//Add this node to the node factory so the vle knows it exists.
NodeFactory.addNode('EstimatePracticeNode', EstimatePracticeNode);

//used to notify scriptloader that this script has finished loading
if(typeof eventManager != 'undefined'){
	eventManager.fire('scriptLoaded', 'vle/node/estimatePractice/EstimatePracticeNode.js');
};