/**
 * Sets the EstimatePracticeNode type as an object of this view
 */
View.prototype.EstimatePracticeNode = {};
 ...
 */
View.prototype.EstimatePracticeNode.commonComponents = [];
 ...
 */
View.prototype.EstimatePracticeNode.generatePage = function(view){
	this.view = view;
	 ...
	 * 
	 * onkeyup will fire the 'estimatePracticeUpdatePrompt' event which will
	 * be handled in the estimatePracticeEvents.js file
	 * 
	 * when you add new authoring components, you will need to create
	 * new events in the estimatePracticeEvents.js file and then
	 * create new functions to handle the event
	 */
	var promptTextArea = createElement(document, 'textarea', {id: 'promptTextArea', rows:'20', cols:'85', onkeyup:"eventManager.fire('estimatePracticeUpdatePrompt')"});
 ...
 */
View.prototype.EstimatePracticeNode.getCommonComponents = function() {
 ...
 */
View.prototype.EstimatePracticeNode.updateContent = function(){
 ...
 */
View.prototype.EstimatePracticeNode.populatePrompt = function() {
 ...
 */
View.prototype.EstimatePracticeNode.updatePrompt = function(){
	/* update content */
...
if(typeof eventManager != 'undefined'){
	eventManager.fire('scriptLoaded', 'vle/node/estimatePractice/authorview_estimatePractice.js');
};